...
Si un agente automatizado trabaja sobre este repositorio, debe seguir la guía definida en [AGENTS.md](./AGENTS.md).
...
Paleta actual definida en `src/settings/_settings.scss`:
...
Colores auxiliares de tema actualmente definidos:

- `$primary-color`: `#b7e2fa`
- `$secondary-color`: `#b8fdd6`
- `$hover-color`: `#deecf8`
- `$selected-color`: `#a4ffd1`
